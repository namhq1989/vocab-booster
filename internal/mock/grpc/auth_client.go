...
// Source: internal/genproto/authpb/hub_grpc.pb.go
//
...
import (
	...
	authpb "github.com/namhq1989/vocab-booster-server-admin/internal/genproto/authpb"
...
func (m *MockAuthServiceClient) IsAdmin(ctx context.Context, in *authpb.IsAdminRequest, opts ...grpc.CallOption) (*authpb.IsAdminResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*authpb.IsAdminResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsAdmin indicates an expected call of IsAdmin.
func (mr *MockAuthServiceClientMockRecorder) IsAdmin(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsAdmin", reflect.TypeOf((*MockAuthServiceClient)(nil).IsAdmin), varargs...)
}
...
// IsAdmin mocks base method.
func (m *MockAuthServiceServer) IsAdmin(arg0 context.Context, arg1 *authpb.IsAdminRequest) (*authpb.IsAdminResponse, error) {
	m.ctrl.T.Helper()
...
// IsAdmin indicates an expected call of IsAdmin.
func (mr *MockAuthServiceServerMockRecorder) IsAdmin(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsAdmin", reflect.TypeOf((*MockAuthServiceServer)(nil).IsAdmin), arg0, arg1)
}
